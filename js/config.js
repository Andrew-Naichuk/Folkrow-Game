...
export const CONFIG = {
    ...
    CAMERA_SPEED: 5,
    INITIAL_BUDGET: 1000, // Starting budget for the player
    ...
    INITIAL_ROOTS: 20, // Initial number of roots in the game
    INITIAL_STUMPS: 30 // Initial number of stumps in the game
};